...
const About = () => {
    ...
    return(
        <section id="about" className={`${currentTheme.GeneralBG} ${currentTheme.GeneralText} h-full poppins-regular grid grid-cols-11 sm:h-screen md:gap-5 lg:gap-10`}>
            ...
            <div className="col-span-10 col-start-2 my-auto tracking-widest leading-7 pr-2 md:col-span-5 lg:col-span-6"> 
                ...
                <div className="poppins-medium my-3 md:text-md">
